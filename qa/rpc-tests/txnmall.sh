...
EARTHDOLLARD=${1}/earthdollard
CLI=${1}/earthdollar-cli
...
echo "Done, earthdollard's shut down. To rerun/poke around:"
echo "${1}/earthdollard -datadir=$D1 -daemon"
echo "${1}/earthdollard -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall earthdollard; rm -rf test.*"
exit 0
